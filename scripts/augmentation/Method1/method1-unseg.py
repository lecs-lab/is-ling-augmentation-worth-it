                            ...
                            if len(l2) > verb_index+1:
                                ...
                                if erg == "E2P" or erg == "E3P":
                                    ...
                                    if l0[verb_index+1] == 'taq':
                                        aug.write(f"""
                                                \\t  {''.join(re.sub(gloss[2][0][verb_index], re.sub(erg_check[orig_erg][0], ergatives[erg][0], gloss[2][0][verb_index], count=1), line0))}
                                                \\p  {''.join(re.sub(gloss[2][1][verb_index], re.sub(erg_check[orig_erg][1], ergatives[erg][1], gloss[2][1][verb_index], count=1), line1))}
                                                \\g  {''.join(re.sub(gloss[2][2][verb_index], re.sub(erg_check[orig_erg][1], ergatives[erg][1], gloss[2][2][verb_index], count=1), line2))} 
                                                \\l  {line3.replace(gloss[5], verb_update)} 
                                        """)
                                        ...
                                        l3 = ' '.join(l3)
                                        aug.write(f"""
                                                \\t  {''.join(re.sub(gloss[2][0][verb_index], re.sub(erg_check[orig_erg][0], ergatives[erg][0], gloss[2][0][verb_index], count=1), l0))}
                                                \\p  {''.join(re.sub(gloss[2][1][verb_index], re.sub(erg_check[orig_erg][1], ergatives[erg][1], gloss[2][1][verb_index], count=1), l1))}
                                                \\g  {''.join(re.sub(gloss[2][2][verb_index], re.sub(erg_check[orig_erg][1], ergatives[erg][1], gloss[2][2][verb_index], count=1), l2))} 
                                                \\l  {l3.replace(gloss[5], verb_update)}   
                                        """)
                                    else:
                                        pass
                            ...
                            if len(l2) > verb_index+1:
                                ...
                                if abs == "A3S":
                                    ...
                                    if l0[verb_index+1] == 'taq':
                                        ...
                                        l3 = ' '.join(l3)
                                        aug.write(f"""
                                                \\t  {''.join(re.sub(gloss[2][0][verb_index], re.sub(abs_check[orig_abs][0], absolutives[abs][0], gloss[2][0][verb_index], count=1), l0))}
                                                \\p  {(''.join(re.sub(gloss[2][1][verb_index], re.sub(abs_check[orig_abs][1], absolutives[abs][1], gloss[2][1][verb_index], count=1), l1))).replace('--', '-')}
                                                \\g  {(''.join(re.sub(gloss[2][2][verb_index], re.sub(abs_check[orig_abs][1], absolutives[abs][1], gloss[2][2][verb_index], count=1), l2))).replace('--', '-')}
                                                \\l  {l3.replace(gloss[5], verb_update)}             
                                        """)
                                    elif l0[verb_index+1] != 'taq':
                                        aug.write(f"""
                                                \\t  {''.join(re.sub(gloss[2][0][verb_index], re.sub(abs_check[orig_abs][0], absolutives[abs][0], gloss[2][0][verb_index], count=1), line0))}
                                                \\p  {(''.join(re.sub(gloss[2][1][verb_index], re.sub(abs_check[orig_abs][1], absolutives[abs][1], gloss[2][1][verb_index], count=1), line1))).replace('--', '-')}
                                                \\g  {(''.join(re.sub(gloss[2][2][verb_index], re.sub(abs_check[orig_abs][1], absolutives[abs][1], gloss[2][2][verb_index], count=1), line2))).replace('--', '-')}
                                                \\l  {line3.replace(gloss[5], verb_update)}  
                                        """)
                                    else:
                                        pass
                                # Output for A2P examples
                                    ...
                                    if l0[verb_index+1] == 'taq':
                                        aug.write(f"""
                                                \\t  {''.join(re.sub(gloss[2][0][verb_index], re.sub(abs_check[orig_abs][0], absolutives[abs][0], gloss[2][0][verb_index], count=1), line0))}
                                                \\p  {''.join(re.sub(gloss[2][1][verb_index], re.sub(abs_check[orig_abs][1], absolutives[abs][1], gloss[2][1][verb_index], count=1), line1))}
                                                \\g  {''.join(re.sub(gloss[2][2][verb_index], re.sub(abs_check[orig_abs][1], absolutives[abs][1], gloss[2][2][verb_index], count=1), line2))} 
                                                \\l  {line3.replace(gloss[5], verb_update)} 
                                        """)
                                    elif l0[verb_index+1] != 'taq':     # Adds plural markers to the first three lines of the gloss if they don't already exist
                                        l0.insert(verb_index+1, 'taq')
                                        ...
                                        aug.write(f"""
                                                \\t  {''.join(re.sub(gloss[2][0][verb_index], re.sub(abs_check[orig_abs][0], absolutives[abs][0], gloss[2][0][verb_index], count=1), l0))}
                                                \\p  {''.join(re.sub(gloss[2][1][verb_index], re.sub(abs_check[orig_abs][1], absolutives[abs][1], gloss[2][1][verb_index], count=1), l1))}
                                                \\g  {''.join(re.sub(gloss[2][2][verb_index], re.sub(abs_check[orig_abs][1], absolutives[abs][1], gloss[2][2][verb_index], count=1), l2))} 
                                                \\l  {l3.replace(gloss[5], verb_update)}   
                                        """)
                                    else:
                                        pass
